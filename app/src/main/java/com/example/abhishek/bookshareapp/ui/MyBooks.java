...
import com.example.abhishek.bookshareapp.ui.adapter.Local.BooksAdapterRemove;
...
public class MyBooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new BooksAdapterRemove(
                id,
                this,
                booksList,
                new BooksAdapterRemove.OnItemClickListener() {
                    @Override
