    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void init() {
                ...
                xMark = ContextCompat.getDrawable(MyBooks2.this, R.drawable.ic_clear_24dp);
                xMark.setColorFilter(Color.WHITE, PorterDuff.Mode.SRC_ATOP);
                xMarkMargin = (int) MyBooks2.this.getResources().getDimension(R.dimen.ic_clear_margin);
                initiated = true;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (itemsPendingRemoval.contains(rbook)) {
                ...
                if(!tempValues.getGrImgUrl().isEmpty()) {
                    Picasso.with(MyBooks2.this).load(tempValues.getGrImgUrl()).into( viewHolder.imageBook);
                }
            ...
            call.enqueue(new Callback<Detail>() {
                ...
                public void onResponse(Call<Detail> call, Response<Detail> response) {
                    if(response.body() != null) {
                        ...
                        Toast.makeText(MyBooks2.this, "Successfully removed", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onFailure(Call<Detail> call, Throwable t) {
                    Toast.makeText(MyBooks2.this, "Check your network connectivity and try again", Toast.LENGTH_SHORT).show();
                }
            });
        }
