...
public class BooksAdapterGR extends RecyclerView.Adapter<BooksAdapterGR.ViewHolder>{
    ...
    private List<com.sdsmdg.bookshareapp.BSA.api.models.Book> bookList;
    com.sdsmdg.bookshareapp.BSA.api.models.Book tempValues=null;
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (items[which].equals("Yes")){
                            ...
                            Call<com.sdsmdg.bookshareapp.BSA.api.models.LocalBooks.Book> addBook = usersAPI.addBook(email,title, author,gr_id,ratingsCount,rating,gr_img_url);
