...
public class CommonUtilities {
    ...
    public static final String local_books_api_url = "http://bookshare-prod.us-east-2.elasticbeanstalk.com/";
    public static final String currentUserImageUrl =
            "http://bookshare-prod.us-east-2.elasticbeanstalk.com/user/image";
    ...
    public static String getAnotherUserImageUrl(String pk){
        String a = "http://bookshare-prod.us-east-2.elasticbeanstalk.com/other_user/image?user_id=" + pk;
        return a;
    }
}
