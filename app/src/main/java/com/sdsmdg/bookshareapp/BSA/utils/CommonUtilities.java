...
public class CommonUtilities {
    ...
    public static final String MSG_AUTH_KEY = "137205Asp4V4I7km85878def9";//#gitignore
    public static final String local_books_api_url = "http://abhisheksachdeva.pythonanywhere.com/";
}
