...
public class CommonUtilities {
    ...
    public static final String local_books_api_url = "https://bookshare-prod.us-east-2.elasticbeanstalk.com/";
    public static final String currentUserImageUrl =
            "https://bookshare-prod.us-east-2.elasticbeanstalk.com/user/image";
    ...
    public static String getAnotherUserImageUrl(String pk){
        String a = "https://bookshare-prod.us-east-2.elasticbeanstalk.com/other_user/image?user_id=" + pk;
        return a;
    }
}
