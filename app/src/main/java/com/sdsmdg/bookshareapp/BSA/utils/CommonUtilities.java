...
public class CommonUtilities {
    ...
    public static final String local_books_api_url = "http://192.168.43.50:8000/";
    public static final String currentUserImageUrl = "http://192.168.43.50:8000/user/image";
    ...
    public static String getAnotherUserImageUrl(String pk){
        String a = "http://192.168.43.50:8000/other_user/image?user_id=" + pk;
        return a;
    }
}
